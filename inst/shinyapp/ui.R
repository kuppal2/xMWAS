...
ui<-fluidPage(
    tags$head(
      ...
      tags$title("xMWAS - v0.55"),
      tags$link(rel = "stylesheet", type = "text/css", href = "mystyle.css")
    ),
    column(12,tags$div(headerPanel(h3("xMWAS - a data-driven integration and network analysis tool (v0.55)")))),
