...
ui<-fluidPage(
    tags$head(
      ...
      tags$title("xMWAS - v0.56"),
      tags$link(rel = "stylesheet", type = "text/css", href = "mystyle.css")
    ),
    column(12,tags$div(headerPanel(h3("xMWAS - a data-driven integration and network analysis tool (v0.56)")))),
 ...
 column(12,  tags$div(style="margin-center",tags$footer(align="center",color="white",style="font-weight:normal;font-size:95%;color:black","Release date: 03/31/2021")))
 )
